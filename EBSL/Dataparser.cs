...
namespace EBSL
{
    ...
    {
        public static Dictionary<Tuple<int, int>, Evidence> parseToEvidence(string filepath, bool IsBidirectional)
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                try
                {
                    ...
                    int nodeA = int.Parse(args[0]);
                    int nodeB = int.Parse(args[1]);
